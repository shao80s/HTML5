...
### 12.19 新的input属性：formnovalidate
...
### 12.21 新的input属性：height 和 width 
...
<p><strong>注:</strong> Internet Explorer 9及更早IE版本，或Safari不支持input标签的 pattern 属性。</p>

</body>
</html>
```

### 12.26 新的input属性： placeholder
...
<p><strong>注：</strong> Internet Explorer 9及更早IE版本，或Safari不支持input标签的 required 属性。</p>

</body>
</html>
```

### 12.28 新的input属性：step
...
> 注:step 属性与以下type类型一起使用: number, range, date, datetime, datetime-local, month, time 和 week.
